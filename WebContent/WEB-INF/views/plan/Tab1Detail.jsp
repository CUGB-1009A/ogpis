			...
			&nbsp;
				...
				<input type="hidden" value="false" name="isAdd"/>			
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-1" placeholder="规划名称..." class="col-xs-10 col-sm-5" name="planName" value="${plan.planName }" >
						</div>
					</div>
					...
					<div class="space-4"></div>
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-2" placeholder="规划代号..." class="col-xs-10 col-sm-5" name="planCode" value="${plan.planCode }" >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-3" placeholder="发布单位..." class="col-xs-10 col-sm-5" name="releaseUnit" value="${plan.releaseUnit }">
						</div>
					</div>
					<div class="space-4"></div>
