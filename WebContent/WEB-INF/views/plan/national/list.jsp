									...
									<tbody>
										<c:forEach items="${nationalPlans.items}" var="item">
											<tr class="odd gradeX">
												...
												<td>${item.explore_CBM}</td>
												<td>${item.explore_SG}</td>
												<td>${item.production_oil}</td>
												<td>${item.production_gas}</td>
												<td>${item.production_CBM}</td>
												<td>${item.production_SG}</td>
												<td>
													<p>
														<a  class="btn-sm btn-app btn-success no-radius" data-toggle="modal" href="<c:url value='/plan/view?id=${item.id }'/>" data-target="#myModal">
