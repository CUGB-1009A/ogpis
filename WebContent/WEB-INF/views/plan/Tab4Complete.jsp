            	...
            	<div class="portlet box light-grey">
					<div class="portlet-body">
						<div class="table-toolbar" style="text-align: right;">
							...
							&nbsp;
							<div class="btn-group">
								<a href="javascript:openTheEditModel();" class="btn-sm btn-app btn-primary no-radius">
		...
		<div class="modal-dialog" style="width:99%">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">完成情况修改</h3>
				</div>
				<div class="modal-body">
					<div class="row">
										 ...
										 <c:forEach items="${map}" var="item">
											<tr class="odd gradeX">				
												...
												<td>${item.key.indexValue}</td>
												 <c:forEach items="${item.value}" var="indexValue">
											 		<td>
											 			<input type="text" id="${indexValue.id}" class="col-xs-10 col-sm-5 indexDataEdit" name="${indexValue.id}" value="${indexValue.finishedWorkload}">
											 		</td>
												 </c:forEach>
											</tr>
										</c:forEach>
						...
						<div class="col-md-12">
							<button class="btn-sm btn-success no-radius" type="button" onclick="editRecord()">
					...
					<label class="col-sm-3 control-label no-padding-right" for="collectedTime">录入时间</label>
					   	...
					   	<div class="col-sm-9">
						   	<div class="input-append date date_picker" data-date-format="dd MM yyyy" data-link-field="collectedTime" data-link-format="yyyy-mm-dd">
						   		<input type="text" id="collectedTime" placeholder="录入时间..." class="col-xs-10 col-sm-5 indexData" name="collectedTime" value="" readonly>
...
function editRecord()
{
	...
	var indexIds="";
	var indexValues="";
	var inputObject = $(".indexDataEdit")
	for(var i=0;i<inputObject.length;i++){
		indexValues += inputObject[i].value+";";
		indexIds += inputObject[i].name+";";
	}
	$.ajax({
		url:"<%=request.getContextPath()%>/indexData/edit",
		dataType:"json",
		async:true,
		data:{"indexIds":indexIds,"indexValues":indexValues,"planId":planId,"type":type},
		type:"GET",
...
function openTheEditModel()
{
	$("#IndexDataEditModal").modal("show");
}
/* 日期选择定制 */
$(function(){
