          ...
          <li>
           ...
           <li>
            ...
            <ul id="international" class="nav nav-list secondmenu collapse" style="height:0px;" >
                <li>
            		<a href="<c:url value='/international/edit?companyName=bp'/>" ><i class="glyphicon glyphicon-star"></i> BP公司<i></i></a>
         		</li> 
                <li>
                    <a href="<c:url value='/international/edit?companyName=kp'/>" ><i class="glyphicon glyphicon-star"></i> 壳牌公司 </a>
                </li>
                <li>
            		<a href="<c:url value='/international/edit?companyName=xfl'/>" ><i class="glyphicon glyphicon-star"></i> 雪福龙</a>
         		</li>
         		<li>
            		<a href="<c:url value='/international/edit?companyName=dde'/>" ><i class="glyphicon glyphicon-star"></i> 道达尔<i></i></a>
         		</li>
         		<li>
            		<a href="<c:url value='/international/edit?companyName=amfks'/>" ><i class="glyphicon glyphicon-star"></i> 艾美浮克森<i></i></a>
         		</li>
            </ul>
         </li>
