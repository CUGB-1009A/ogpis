          ...
          <li>
           ...
           <li>
            ...
            <ul id="international" class="nav nav-list secondmenu collapse" style="height:0px;" >
                <li>
            		<a href="<c:url value='/international/edit?companyName=bp'/>" ><i class="glyphicon glyphicon-star"></i> 英国石油<i></i></a>
         		</li> 
                <li>
                    <a href="<c:url value='/international/edit?companyName=kp'/>" ><i class="glyphicon glyphicon-star"></i> 壳牌 </a>
                </li>
                <li>
            		<a href="<c:url value='/international/edit?companyName=xfl'/>" ><i class="glyphicon glyphicon-star"></i> 雪佛龙</a>
         		</li>
         		<li>
