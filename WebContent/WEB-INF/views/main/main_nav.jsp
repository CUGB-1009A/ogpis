    ...
    <ul class="nav navbar-nav side-nav pull-left">   
         ...
         <li>
            ...
            <ul id="international" class="nav nav-list secondmenu collapse" style="height:0px;" >
                <li>
            		<a href="<c:url value='/international/show?companyName=bp'/>" class="menu"><i class="glyphicon glyphicon-star"></i> 英国石油<i></i></a>
         		</li> 
                <li>
                    <a href="<c:url value='/international/show?companyName=kp'/>" class="menu"><i class="glyphicon glyphicon-star"></i> 壳牌 </a>
                </li>
                <li>
            		<a href="<c:url value='/international/show?companyName=xfl'/>" class="menu"><i class="glyphicon glyphicon-star"></i> 雪佛龙</a>
         		</li>
         		<li>
            		<a href="<c:url value='/international/show?companyName=dde'/>" class="menu"><i class="glyphicon glyphicon-star"></i> 道达尔<i></i></a>
         		</li>
         		<li>
            		<a href="<c:url value='/international/show?companyName=amfks'/>" class="menu"><i class="glyphicon glyphicon-star"></i> 埃克森美孚<i></i></a>
         		</li>
            </ul>
         </li>
