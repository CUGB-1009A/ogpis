...
<div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav pull-left" id="menuList" align="left">
       ...
       <shiro:hasPermission name="nationalPlan">
         <li>
